...
It covers UTF-8 child-process integration with MeCab, access to morphological analysis data, split feature fields, practical bunsetsu-like phrase grouping, symbol-range separation, and the basis for readable spacing, readings, ruby, romanization, braille-oriented conversion, and related counts.
