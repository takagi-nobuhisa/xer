...
Target version: **v0.1.0b1**

> This file is generated by `php/generate_reference_manual.php`.
> Do not edit this file directly unless you intentionally want to overwrite generated output.

## Overview

This reference manual is generated from public-header documentation fragments under `docs/bits/`.
The current initial generator intentionally keeps the process simple:

- it reads the public header order from `docs/public_headers.md`
- it reads the version string from `xer/version.h`
- it concatenates `docs/bits/header_*.md` in public-header order

Later, this generator may also incorporate examples, source-level API extraction, and additional reusable documentation snippets.
