 ...
 */
[[nodiscard]] inline constexpr auto is_utf8_continuation(std::uint8_t byte) -> bool
{
 ...
 */
[[nodiscard]] inline constexpr auto is_cp932_single_byte(std::uint16_t packed) -> bool
{
 ...
 */
[[nodiscard]] inline constexpr auto is_cp932_lead_byte(std::uint8_t byte) -> bool
{
 ...
 */
[[nodiscard]] inline constexpr auto is_cp932_trail_byte(std::uint8_t byte) -> bool
{
 ...
 */
[[nodiscard]] inline constexpr auto packed_utf8_to_utf32(std::uint32_t packed) -> char32_t
{
 ...
 * @return UTF-32 code point, or `static_cast<char32_t>(-1)` on failure.
 */
[[nodiscard]] inline constexpr auto packed_utf16_to_utf32(std::uint32_t packed) -> char32_t
{
 ...
 * @return UTF-32 code point, or `static_cast<char32_t>(-1)` on failure.
 */
[[nodiscard]] inline constexpr auto packed_cp932_to_utf32(std::uint16_t packed) -> char32_t
{
